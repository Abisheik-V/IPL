                ...
                item =>
                    new Promise(resolve => {
                        ...
                        img.onerror = () => {
                            ...
                            resolve(img); // Continue anyway may result in empty texture part
                        };
                        img.src = item.image;
                    })
            )
...
const defaultItems = [
    {
        image: `${import.meta.env.BASE_URL}images/csk.png`,
        link: 'https://www.chennaisuperkings.com/',
        title: 'Chennai Super Kings',
        description: 'Whistle Podu!'
    },
    {
        image: `${import.meta.env.BASE_URL}images/mi.png`,
        link: 'https://www.mumbaiindians.com/',
        title: 'Mumbai Indians',
        description: 'Duniya Hila Denge'
    },
    {
        image: `${import.meta.env.BASE_URL}images/rcb.png`,
        link: 'https://www.royalchallengers.com/',
        title: 'Royal Challengers Bangalore',
        description: 'Play Bold'
    },
    {
        image: `${import.meta.env.BASE_URL}images/dc.png`,
        link: 'https://www.delhicapitals.in/',
        title: 'Delhi Capitals',
        description: 'Yeh Hai Nayi Dilli'
    },
    {
        image: `${import.meta.env.BASE_URL}images/kkr.png`,
        link: 'https://www.kkr.in/',
        title: 'Kolkata Knight Riders',
        description: 'Korbo Lorbo Jeetbo'
    },
    {
        image: `${import.meta.env.BASE_URL}images/srh.png`,
        link: 'https://www.sunrisershyderabad.in/',
        title: 'Sunrisers Hyderabad',
        description: 'Orange Army'
    },
    {
        image: `${import.meta.env.BASE_URL}images/pbks.png`,
        link: 'https://www.punjabkingsipl.in/',
        title: 'Punjab Kings',
        description: 'Sadda Punjab'
    },
    {
        image: `${import.meta.env.BASE_URL}images/rr.png`,
        link: 'https://www.rajasthanroyals.com/',
        title: 'Rajasthan Royals',
        description: 'Halla Bol'
    },
    {
        image: `${import.meta.env.BASE_URL}images/gt.png`,
        link: 'https://www.guitartitans.in/',
        title: 'Gujarat Titans',
        description: 'Aava De'
    },
    {
        image: `${import.meta.env.BASE_URL}images/lsg.png`,
        link: 'https://www.lucknowsupergiants.in/',
        title: 'Lucknow Super Giants',
        description: 'Gazab Andaz'
    }
];

export default function InfiniteMenu({ items = defaultItems, scale = 1.0 }) {
    ...
    return (
        <div style={{ position: 'relative', width: '100%', height: '800px', backgroundColor: 'transparent' }}>
